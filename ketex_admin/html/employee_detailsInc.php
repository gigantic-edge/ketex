                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <button type="button" class="btn btn-success" onclick="window.location.href = 'add_department.php'">Add Department</button>
                                    ...
                                    if (!empty($profilearr)):
                                        ...
                                        foreach ($profilearr as $k => $v):
                                            ...
                                            <tr text>
                                                ...
                                                <a class="btn btn-info btn-sm" href="edit_department.php?id=<?php echo $v['dep_id'] ?>">Edit</a></td>                                                </td>
