                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <button type="button" class="btn btn-success" onclick="window.location.href = 'addManagement.php'">Add Page</button>
...
<!-- 
                            ...
                            <table  class="table table-striped- table-bordered table-hover table-checkable" id="dtBasicExample" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    //     $query="SELECT * FROM pages WHERE CONCAT(page_title, page_heading) LIKE '%$filtervalues%'";    
                                    ...
                                    if (!empty($management)):
                                        ...
                                        foreach ($management as $k => $v):
                                            ...
                                            <tr text>
                                                ...
                                                <td> <b><?php echo $v['page_title'] ?></b></td>
                                                
                                                <td> <b><?php echo $v['page_heading'] ?></b></td>
                                                <td> <b><?php echo $v['meta_description'] ?></b></td>
                                                <td> <b><?php echo $v['meta_keywords'] ?></b></td>
                                                <td>

                                                <a class="btn btn-info btn-sm" href="editManagement_d.php?id=<?php echo $v['page_id'] ?>">Edit</a></td>                                                </td>
