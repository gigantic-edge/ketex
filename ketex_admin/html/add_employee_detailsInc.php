    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <form method="post" action="db_add_employee.php" enctype="multipart/form-data">
                    <div class="modal-body col-md-6">

                    <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Department Designation</label>
                                <!-- <select class="form-control m-select2" id="m_select2_2"  name="cat_id" multiple="multiple" > -->
                                <select class="form-control" id="m_select2_2"  name="dep_id">
                                <option>Select</option>

                                    <?php
                                    foreach ($category_dep as $k4 => $v4) {
                                    ?>
                                        <option value="<?php echo $v4['dep_id'] ?>"><?php echo $v4['department_name'] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
