            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <a href="">
                        ...
                        Employee department details</h3>
                    </a>
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        ...
                        <div class="table-responsive" id="modelTable">
                            <table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
                                ...
                                <tbody>
                                    <?php
                                    if (!empty($emp_detailsArr)):
                                        $i = 1;
                                        foreach ($emp_detailsArr as $k => $v):
                                          //  print_r($product_details);
                                            ...
                                            <tr text>
                                                ...
                                                <td> 
                                                 <?php if ($v['employee_image'] != '') { ?>

                                                    <img src="
                                                        <?php echo $database->base_url . $database->document_path_site_image . $v['employee_image']; ?>" width="100"/>
                                                    <?php } ?>
                                                </td>   
                                                
                                                <td> <b><?php echo $v['employee_name'] ?></b></td>
                                                <td> <b><?php echo $v['emp_designation'] ?></b></td>
                                               
                                                <td> <b><?php echo $v['create_add'] ?></b></td>
                                                <td> <b><?php echo $v['update_add'] ?></b></td>
                                                <td>

                                                    <a class="btn btn-info btn-sm" href="editEmployee_details.php?id=<?php echo $v['emp_id'] ?>"><i class="fa fa-edit" style="font-size:15px">&nbsp;&nbsp;Edit</i></a><br>
