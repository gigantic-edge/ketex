                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <button type="button" class="btn btn-success" onclick="window.location.href = 'addJourney.php'">Add Journey</button>
                                    ...
                                    if (!empty($branchesArr)):
                                        ...
                                        foreach ($branchesArr as $k => $v):
                                            ...
                                            <tr text>
                                                ...
                                                <a class="btn btn-info btn-sm" href="editJourney.php?id=<?php echo $v['id'] ?>">Edit</a></td>                                                </td>
