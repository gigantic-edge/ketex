                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <h3 class="m-portlet__head-text">
                                <button type="button" class="btn btn-success" onclick="window.location.href = 'addProfile.php'">Add Category</button>
                                    ...
                                    if (!empty($profilearr)):
                                        ...
                                        foreach ($profilearr as $k => $v):
                                            ...
                                            <tr text>
                                                ...
                                                <a class="btn btn-info btn-sm" href="editProfile.php?id=<?php echo $v['cat_id'] ?>">Edit</a></td>                                                </td>
