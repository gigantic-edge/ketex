    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <!-- <div class="m-portlet m-portlet--mobile">
                ...
                <form method="post" action="db_add_application_details.php" enctype="multipart/form-data">
                    <div class="modal-body col-md-6">

                    <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Application Category</label>
                    ...
                    <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Application Image</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                ...
                                <textarea  rows="20" cols="100" name="app_description" class="form-control" ></textarea>
