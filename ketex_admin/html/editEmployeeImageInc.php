    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <form class="m-form m-form--fit m-form--label-align-right" method="post" action="db_image.php"  enctype="multipart/form-data">
                    ...
                    <div class="col-md-5">
                            ...
                            <div class="form-group m-form__group row">                                
                                ...
                                <img src="
                                <?php if ($singleproarr2['employee_image'] != '') { ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Employee image Upload</label>
