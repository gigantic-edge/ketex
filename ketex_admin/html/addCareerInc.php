    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <form method="post" action="db_add_career.php" enctype="multipart/form-data">
...
<!--                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Linkedin Id</label>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Past Designation </label>
                                <input type="text" name="in_designation" class="form-control" />

                            </div>
                        </div>
                       <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label "> Previous Company Image (Image size - 300px(w) x 450px(h))</label>
                                <input type="file" name="in_logo_img" class="form-control"/>
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                ...
                                <input type="text" name="out_designation" class="form-control" />

                            </div>
                        </div>
                        <div class="col-md-12">
                          <div class="form-group m-form__group row">
                                <label class="col-form-label "> Present Company Image (Image size - 300px(w) x 450px(h))</label>
                                <input type="file" name="out_logo_img" class="form-control"/>

                            </div>
                        </div>
                           <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label "> Career Transformation Journey</label>
