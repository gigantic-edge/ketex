    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-alert m-alert--icon m-alert--air m-alert--square alert alert-dismissible m--margin-bottom-30" role="alert">
            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <form class="m-form m-form--fit m-form--label-align-right" method="post" action="department_edit.php"  enctype="multipart/form-data">

                    <input type="hidden" name="profile_id" value="<?php echo $departmentarr['dep_id'] ?>" required> 

                    <div class="m-portlet__body col-md-6">
                        <div class="col-md-12">
                            <div class="form-group m-form__group row">
                                <label class="col-form-label ">Department Name</label>
                                <input type="text" class="form-control" name="department_name" value="<?php echo $departmentarr['department_name'] ?>">
                            </div>
                        </div>
