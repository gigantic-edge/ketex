...
<div class="content-wrapper">
    ...
    <section class="content"> 
        <div class="row">
            ...
            <a style="background-color: #00b3ff;color: #fff;padding: 5px;" href="addjob.php"><i class="fa fa-plus"></i> Add Job</a>
              
            <!--<a style="background-color: red;color: #fff;padding: 5px;display:none;cursor:pointer" id="deleteBtn"><i class="fa fa-trash"></i> Delete job</a>-->
...
?>                    
                    <tr>
                      ...
                      <td><?php echo strlen(strip_tags($row['job_detail'])) > 100 ? substr(strip_tags($row['job_detail'],'<br>'),0,100)."..." : strip_tags($row['job_detail'],'<br>'); ?></td>
                      <td><?php echo $row['sort_number'];?></td>
                      <td><?php echo $row['created_at'];?></td>
                      <td><?php echo $row['update_at'];?></td>
                      <td>
                      <a href="addjob.php?id=<?php echo $row['job_id'];?>" style="background-color: #00b3ff;padding: 5px;color: #fff;"><i class="fa fa-pencil"></i> Edit</a><br><br>
                      <a onClick="return confirm('Do you want to Delete ?')" href="deletejob.php?id=<?php echo $row['job_id'];?>" style="background-color: red;padding: 5px;color: white;">Delete</a>
                      </td>
                    </tr>
 <?php $i++; } ?> 
                            </tbody>
