...
if(isset($_GET['id'])){
    $sql ="SELECT * FROM `application_category` WHERE `cat_id` = '".$_GET['id']."' ";
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Add Application Category</h3>
                    </div>
                    ...
                    <form role="form" id="addUser" action="applicationCategoryData.php" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12 ">                                
            ...
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Application Category List </h3>
                    </div>
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
<?php 
$sql ="SELECT * FROM `application_category` ORDER BY `cat_name` ASC ";
...
?>                    
                    <tr>
                      ...
                      <td><a href="?id=<?php echo $row['cat_id'];?>" style="background-color: #00b3ff;color: #fff;padding: 5px;"><i class="fa fa-pencil"></i> Edit</a>
                          <a style="background-color: red;padding: 5px;color: #fff;cursor:pointer;" 
                          onclick="javascript:RemoveData(<?php echo $row['cat_id'];?>);"><i class="fa fa-trash"></i>Delete</a>
                        </td> 
                    </tr>
 <?php $i++; } ?> 
                            </tbody>
...
<script>
    function RemoveData(id){
        if (confirm('Are You Sure To Delete Application Category?')) {
        $.ajax({
            type:'post',
            url:'deleteSingleData.php',
            data: 'tableName=application_category&key=cat_id&value='+id,
