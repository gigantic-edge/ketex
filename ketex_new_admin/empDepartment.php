...
if(isset($_GET['id'])){
    $sql ="SELECT * FROM `employee_department` WHERE `dep_id` = '".$_GET['id']."' ";
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="empDepartmentData.php" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12 ">                                
                                    <div class="form-group">
                                        <label for="fname">Department Name *</label>
                                        <input type="text" name="department_name" class="form-control required" required placeholder="Department Name"
                                        <?php if(isset($_GET['id'])){?> value="<?php echo $categoryData['department_name'];?>" <?php } ?>>
                                    </div>
                                </div>
                                <div class="col-md-12 ">                                
                                    <div class="form-group">
                                        ...
                                        <?php if(isset($_GET['id'])){?> value="<?php echo $categoryData['sort_number'];?>" <?php } ?>>
                                    </div>
                                </div>
                        ...
                        <div class="box-footer">
                            ...
                            <input type="hidden" name="id" value="<?php echo $categoryData['dep_id'];?>">
                ...
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
<?php 
$sql ="SELECT * FROM `employee_department` ORDER BY `sort_number` ASC ";
...
?>                    
                    <tr>
                      ...
                      <td><a href="?id=<?php echo $row['dep_id'];?>" style="background-color: #00b3ff;color: #fff;padding: 5px;"><i class="fa fa-pencil"></i> Edit</a><br>
                          <a style="background-color: red;padding: 5px;color: #fff;cursor:pointer;" 
                          onclick="javascript:RemoveData(<?php echo $row['dep_id'];?>);"><i class="fa fa-trash"></i>Delete</a>
                        </td>      
                    </tr>
 <?php $i++; } ?> 
                            </tbody>
...
<script>
    function RemoveData(id){
        ...
        $.ajax({
            ...
            data: 'tableName=employee_department&key=dep_id&value='+id,
